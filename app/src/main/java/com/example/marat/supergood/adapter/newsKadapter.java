...
public class newsKadapter extends RecyclerView.Adapter<newsKadapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View v) {
            super(v);
            mTextView =  v.findViewById(R.id.textView70);
            mTextView1 =  v.findViewById(R.id.textView71);
            mTextView2 =  v.findViewById(R.id.textView72);
        ...
        public void onClick(View view) {
            ...
            intent = new Intent(view.getContext(), newsActivityK.class);
            intent.putExtra("pos", url);
            view.getContext().startActivity(intent);
        }
    }

    public newsKadapter(Context context, ArrayList<String> dataset, ArrayList<String> dataset2, ArrayList<String> dataset3,
    ...
    @Override
    public newsKadapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.newskmain, parent, false);
