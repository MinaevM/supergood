...
public class newsI extends Fragment {
    ...
    class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                Element newselem = doc.select("div[id=content]").first();
                Elements title = newselem.select("div.news_items_right>a");
                Elements pubDate = newselem.select("span.date");
                Elements textelem = newselem.select("div.news_items_right>p");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View q=inflater.inflate(R.layout.newstab, container, false);

        intent = new Intent(getActivity(), newsActivityI.class);
